...
//		System.out.println(hotplaySvList);
		...
		try {
			JSONObject author = new JSONObject(strHtml);
			Object data2=author.get("data2");
			System.out.println(data2);
			JSONArray arraylist = (JSONArray) data2;
...
//			System.out.println(iObj);
			...
			System.out.println(MovieName=(String) iObj.get("MovieName"));
...
//	}
	...
	public static void main(String[] args) {
		...
		mainUrl("http://www.cbooo.cn/boxOffice/GetHourBoxOffice");
