...
//				 -0).toString().replace("-", ""));
		...
		public static void runstaticshijian(){
			...
			if (TimeTest.getNowTime("HH").equals("12") || TimeTest.getNowTime("HH").equals("09")) {
				CommonUtil.setLog("type:开始||date:" + TimeTest.getNowTime("yyyy-MM-dd HH:mm:ss") + "||logs:中国票房网票房城市地区 任务开始;");
				runstatic();
				CommonUtil.setLog("type:结束||date:" + TimeTest.getNowTime("yyyy-MM-dd HH:mm:ss") + "||logs:中国票房网票房城市地区 任务结束;");
			}
