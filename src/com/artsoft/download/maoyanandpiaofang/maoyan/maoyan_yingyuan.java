...
//		System.out.println(data_date = data_date.replace("-", ""));
		...
		for (Element link : links) {
			...
			for (int i = 1; i < 2; i++) {
				...
				String cityurl="http://pf.maoyan.com/company/cinema?typeId=0&date="+datetext+"&webCityId="+cityid+"&cityTier=0&page="+i+"&noSum=0&cityName="+Cityutf+"";
				String strcityHtml = "";
...
//						System.out.println(doclinkId.getElementById("tab-cont"));
						Elements ultheatre = doclinkId.getElementById("tab-cont").select("div.theatre-list div ul");
