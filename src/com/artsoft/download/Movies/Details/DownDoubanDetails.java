...
public class DownDoubanDetails {
	...
	public static void iQiYiBranch(String urlBranch, String name) {
		...
		// "/?callback=window.Q.__callbacks__.cbrymman";
		...
		//
		// String videourl =
		// "http://up.video.iqiyi.com/ugc-updown/quud.do?dataid=" + videoId
		// +
		// "&type=1&userid=&flashuid=e42dc42f8825edf5580806cde99606ce&appID=21&callback=window.Q.__callbacks__.cb1953yg";
		//
		// String feishuhtml = DownloadUtil.getHtmlText(videourl, 1000 * 30,
		// "UTF-8", null, null);
		// String feishu = "";
		// System.out.println(feishu = HtmlAnalyze.getTagText(feishuhtml,
		// "score\":", ",\""));
		//
		// OracleOpreater.intoReputation(name, "2", feishu, "0", "", urlBranch,
		// "1", "1");
		// } catch (Exception e) {
		// // TODO: handle exception
		// }
	...
	public static void runstatic() {
		...
		for (String stringtext : list) {
			for (int i = 0; i <= 500; i = i + 20) {
				// System.out.println(i);
				try {
					DownDoubanDetails.mainurl("http://movie.douban.com/j/search_subjects?type=movie&tag="
							+ java.net.URLEncoder.encode(stringtext, "utf-8")
							+ "&sort=recommend&page_limit=20&page_start=" + i);
