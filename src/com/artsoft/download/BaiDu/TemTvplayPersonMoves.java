...
//				OracleHaoSou.InsertTVplay(tvplay);// 添加操作
	...
	private static void runnewMainurl() {
		// TODO Auto-generated method stub
		
		List<String> listArray = OracleBaidu.selectmove_zhuyanshujutupianxianzai();
		for (Object Objstring : listArray) {
			System.out.println(Objstring);
			List<String> listTemp = (List<String>) Objstring;
			String id = "";
...
//		TemTvplayPerson.play_people("0", "嘻哈四重奏", "http://baike.baidu.com/item/%E5%98%BB%E5%93%88%E5%9B%9B%E9%87%8D%E5%A5%8F/3177892", 3);
	}
