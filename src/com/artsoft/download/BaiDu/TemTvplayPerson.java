...
//		Document doc = Jsoup.parse(strHtml);
		...
		for (Element elementli : linkli) {
			...
			if (title.equals("")) {
				title=HtmlAnalyze.getTagText(elementli.toString(), "<dt>", "&nbsp;饰&nbsp");
			}
			...
			System.out.println(ROLE_NAME = HtmlAnalyze.getTagText(elementli.toString(), "饰&nbsp;", "</dt>"));
...
//		play_people("0", "欢乐颂", "http://baike.baidu.com/link?url=DyeQ2-aSHRhiQ4kpvaDbQXqZK7negVOH5MyhqLVxQQZc6lIuWN4RP5Z3AAuTPMsNooELgs01WtdoIEE-TB8dmnB8iwlBlIqFpip0FgALWhZ0cNSkDRjlZGc74UhRtFn1", 0);
