...
public class BaiDuTeleplayUrlZhongYiScript {
...
//			}
	...
	public static void runnewMainurl(){
		List<String> listArray = OracleBaidu.selectbaidudianshijuzhongyiScropt();
...
//			id="173";
//			name="爱情36计";
//			url="http://baike.baidu.com/item/爱情36计/5718421";
			String url1=url;
...
//				url="";
				...
				TvPlay tvplay=null;
				try {
					 tvplay = BaiDuTeleplayDownload.mainmore(id, url, name);
					
				} catch (Exception e) {
					// TODO: handle exception
					 tvplay = BaiDuTeleplayDownload.mainmore(id, url1, name);
				}
//					tvplay.setBaikefilmname(strUrlname);
//					tvplay.setBAIKE_NAME(strUrlname);
				tvplay.setType(3);
...
//		runnewMain();
		//有url
		BaiDuTeleplayUrlZhongYiScript.runnewMainurl();
	}
