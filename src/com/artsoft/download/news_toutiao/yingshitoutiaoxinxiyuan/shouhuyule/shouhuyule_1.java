...
//		="http://ent.163.com/special/yyx/";
		...
		//
		Elements links = doc.select("div.f14list ul li");
...
//				wechat.setNames(names);
				...
				wechat.setDates(DATES);
				String CONTENT_ALL=docs.getElementById("contentText").toString();
...
//				String CONTENT_P=docs.select("article-detail");
				...
				Elements  js_contentps=docs.getElementById("contentText").select("p");
...
//					dbm.executeCall(TimeTest.getNowTime("yyyyMMdd"));
	...
	//TimingTime(1, 59, 59);
		runnewMain("http://yule.sohu.com/tv.shtml",2);
	}
