		...
		try {
			...
			for (Object object : letvjsonArray) {
				...
				if (name != null && Amount != null && mainUrl != null && !Amount.equals("")) {
					OracleOpreater.intoReputationAndDETAIL_URL(name, "5", Amount, "0", "", mainUrl, "2", "0",
							DETAIL_URL);
				} else {
					OracleOpreater.intoReputationAndDETAIL_URL(name, "5", "-1", "0", "", mainUrl, "2", "0", DETAIL_URL);
				}
				// } catch (Exception e) {
				// // TODO: handle exception
				// }
				...
				if (name != null && score != null && mainUrl != null && !score.equals("")) {
					OracleOpreater.intoReputationAndDETAIL_URL(name, "5", score, "0", "", mainUrl, "2", "1",
							DETAIL_URL);
				} else {
					OracleOpreater.intoReputationAndDETAIL_URL(name, "5", "-1", "0", "", mainUrl, "2", "1", DETAIL_URL);
