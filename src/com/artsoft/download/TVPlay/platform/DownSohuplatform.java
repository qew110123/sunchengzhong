...
//		yanyuan = yanyuan.replaceAll("\r\n\t", "").replaceAll("\t", "").replaceAll("/", "|,");
	...
	public static void sohuDetailed(String urlerer, String title) {
		...
		try {
			...
			OracleOpreater.intoReputationAndDETAIL_URL(tyPlayName, serNumber, source, playAmount, vodeoType, palydate,
					playUrl, tvType, urlerer);
		} catch (Exception e) {
			// TODO: handle exception
		}
	...
	public static void main(String[] args) {
		...
		// ":开始");
		// for (int i = 1; i <= 72; i++) {
		// sohuMain("http://so.tv.sohu.com/list_p1101_p2_p3_p4-1_p5_p6_p77_p80_p9_p10"
		// + i + "_p11_p12_p13.html");
		//
		// }
		// try {
