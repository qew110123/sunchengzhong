...
public class DownloadIqiyi {
	...
	public static void iQiYiBranch(String urlBranch, String name, String score) {
		...
		PRODUCTION_AREA=HtmlAnalyze.getTagText(strHtml, "地区：", "</p>");
		playtv.setProduction_area(PRODUCTION_AREA);
		
		String SUBJECT="";
		SUBJECT=HtmlAnalyze.getTagText(strHtml, "类型：", "</p>");
...
//		playtv.setDirector(daoyan);
		...
		String DIRECTOR="";
		DIRECTOR=HtmlAnalyze.getTagText(strHtml, "导演：", "</p>");
		playtv.setDirector(DIRECTOR);
		
		

		String yanyuan = "";// 演员
		String yanyuanAll = HtmlAnalyze.getTagText(strHtml, "<p class=\"li-large\">主演：", "</p>", true, 0);
	...
	public static void main(String[] args) {
		...
		iQiYiBranch("http://www.iqiyi.com/a_19rrhaj295.html#vfrm=2-4-0-1", "我是你的百搭", "6.8");
	}
}
