...
public class WeBoWangJu {
	
	
	
	public static void mainProgram(int statnum, int endnum) {
		// TODO Auto-generated method stub
		List<String> listArray = OracleHaoSou.selectdim_film_wangluoju(Integer.toString(statnum), Integer.toString(endnum));
...
//				String data_date = TimeTest.getNowTime("yyyyMMdd");
				...
				/**
				 * 名称  
				 * data_type 类型 1 人 2 电视剧 3 电影 4网剧
				 * data_id  人物id
				 */
				WeBoDajiewang.webopeople(keyword,4,person_id);
...
//		String returnNumTVle=OracleHaoSou.returnNumPeople("ods.dim_film");
		String returnNumTVle=OracleHaoSou.returnNumPeople("ODS.DIM_NETWORK_TVPLAY");
