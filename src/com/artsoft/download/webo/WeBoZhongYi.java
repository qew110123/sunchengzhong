...
public class WeBoZhongYi {
	public static void mainProgram(int statnum, int endnum) {
		// TODO Auto-generated method stub
		List<String> listArray = OracleHaoSou.selectdim_film_zhongyi(Integer.toString(statnum), Integer.toString(endnum));
...
//				String data_date = TimeTest.getNowTime("yyyyMMdd");
				...
				/**
				 * 名称  
				 * data_type 类型 1 人 2 电视剧 3 电影 4网剧 5综艺
				 * data_id  人物id
				 */
				WeBoDajiewang.webopeople(keyword,5,person_id);
...
//			int TV_TYPE=0;
	...
	public static void runstatic() {
		...
		CommonUtil.setLog("type:开始||date:" + TimeTest.getNowTime("yyyy-MM-dd HH:mm:ss") + "||logs:微博指数-综艺 任务开始;");
		openstatic();
		CommonUtil.setLog("type:结束||date:" + TimeTest.getNowTime("yyyy-MM-dd HH:mm:ss") + "||logs:微博指数-综艺 任务结束;");
